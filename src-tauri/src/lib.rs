...
use commands::{backup, changelog, entities, events, export, genres, import, links, maintenance, media, query, setlists, settings, stats, tags, theme};
use tauri::Manager;
...
pub fn make_specta_builder() -> tauri_specta::Builder<tauri::Wry> {
    tauri_specta::Builder::<tauri::Wry>::new()
        .commands(tauri_specta::collect_commands![
            ...
            tags::add_artist_tag,
            tags::remove_artist_tag,
            tags::suggest_artist_tags,
            tags::get_similar_artists_by_tags,
            tags::get_common_tags,
            tags::add_common_tag,
            tags::remove_common_tag,
