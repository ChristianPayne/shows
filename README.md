...
- **Events** — full CRUD, multi-day support (start/end dates), cancelled event tracking, free-form notes, friend tagging, drag-and-drop artist reordering, form validation, and a `Cmd/Ctrl+N` shortcut to start a new event from anywhere
...
- **Accent colors** — 8 presets, persisted
